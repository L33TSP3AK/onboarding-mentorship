...
(function() {
  ...
  var MainButton = function() {
    ...
    Object.defineProperty(mainButton, "text", {
      set: function(val2) {
        mainButton.setParams({ text: val2 });
      },
      get: function() {
        return buttonText;
      },
    ...
    Object.defineProperty(mainButton, "color", {
      set: function(val2) {
        mainButton.setParams({ color: val2 });
      },
      get: function() {
    ...
    Object.defineProperty(mainButton, "textColor", {
      set: function(val2) {
        mainButton.setParams({ text_color: val2 });
      },
      get: function() {
    ...
    Object.defineProperty(mainButton, "isVisible", {
      set: function(val2) {
        mainButton.setParams({ is_visible: val2 });
      },
      get: function() {
        return isVisible;
      },
    ...
    Object.defineProperty(mainButton, "isActive", {
      set: function(val2) {
        mainButton.setParams({ is_active: val2 });
      },
      get: function() {
        return isActive;
      },
  ...
  WebApp2.openLink = function(url, options) {
    ...
    options = options || {};
    if (versionAtLeast("6.1")) {
      WebView.postEvent("web_app_open_link", false, { url, try_instant_view: versionAtLeast("6.4") && !!options.try_instant_view });
    } else {
      window.open(url, "_blank");
    }
  };
  WebApp2.openTelegramLink = function(url) {
    var a = document.createElement("A");
    a.href = url;
    if (a.protocol != "http:" && a.protocol != "https:") {
      console.error("[Telegram.WebApp] Url protocol is not supported", url);
  ...
  WebApp2.openInvoice = function(url, callback) {
...
var WebApp = telegramWindow.Telegram.WebApp;

// ../node_modules/@twa-dev/sdk/dist/index.js
var dist_default = WebApp;
export {
